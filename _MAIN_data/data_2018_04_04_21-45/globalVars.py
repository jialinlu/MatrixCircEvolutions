...
Here, the problem is also chosen (PROBLEMname). This is the cost function (high-level definition) name from the script scoreFunctions.py. 

TODO: change all variables vrom variable_name to gVariable_name for better outlook and code clarity.
"""
...
minimalScore = 0.1 	#stopping criteria based on Score (cost function)
#---------------------------------------------------
...
NofPARAMS = 0
for element in buildBlocks:
  NofPARAMS = NofPARAMS + element['NofParameters']*element['Quantity']
